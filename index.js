...
const app = express();
Cfonts.say('ArulKunzzGT',{font: 'tiny'})
app.get('/', (req, res) => {
  res.setHeader('Content-Type', 'application/json');
  const data = {
    status: 'true',
message: 'Bot {global.version} is now running',
    author: 'https://github.com/ArulKunzzGT'
  };
...
console.log(chalk.white.bold(`####################################
      ${chalk.yellow.bold("ALOK BOT")}         
        VER 4.0
    MADE BY ${chalk.yellow.bold("GT TEAM")}
 
✅ WhatsApp: ${chalk.blue.underline("wa.me/${nomerown}")}
👥 Github: ${chalk.blue.underline("https://github.com/ArulKunzzGT")}
